...
const routes = [
    {
        path: 'dashboard',
        loadChildren: () => Promise.all(/*! import() | dashboard-dashboard-module */[__webpack_require__.e("default~dashboard-dashboard-module~sign-in-sign-in-module~sign-up-sign-up-module"), __webpack_require__.e("dashboard-dashboard-module")]).then(__webpack_require__.bind(null, /*! ./dashboard/dashboard.module */ "TDBs")).then(m => m.DashboardModule)
    },
    {
        path: 'sign-up',
        loadChildren: () => Promise.all(/*! import() | sign-up-sign-up-module */[__webpack_require__.e("default~dashboard-dashboard-module~sign-in-sign-in-module~sign-up-sign-up-module"), __webpack_require__.e("default~sign-in-sign-in-module~sign-up-sign-up-module"), __webpack_require__.e("sign-up-sign-up-module")]).then(__webpack_require__.bind(null, /*! ./sign-up/sign-up.module */ "kEuc")).then(m => m.SignUpModule)
    },
    {
        path: 'sign-in',
